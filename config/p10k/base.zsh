...
# Classic powerline style with nerd fonts
# Generated for SoulOfNix
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_FOLDER_MARKER='(.shorten_folder_marker|.bzr|CVS|.git|.hg|.svn|.terraform|.citc|.idea|.vscode)'
  ...
  typeset -g POWERLEVEL9K_VCS_{CLEAN,MODIFIED,UNTRACKED,CONFLICTED,LOADING}_CONTENT_EXPANSION='${P9K_CONTENT}'

  # Git status: show staged, unstaged, untracked counts
